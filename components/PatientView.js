    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex flex-col">
        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div>
              ...
              <p className="text-white text-lg font-semibold">Midnight Radio, 1968 • Soul Classics</p>
            </div>
          </div>
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-2xl">
          ...
          <div className="bg-gradient-to-br from-purple-800/40 to-purple-900/20 border border-purple-600/30 rounded-2xl p-12 md:p-16">
            ...
            <div className="space-y-8 text-center">
              <p className="text-5xl md:text-6xl font-black text-white leading-tight">
                ...
                <span className="bg-gradient-to-r from-pink-500 to-orange-500 text-white px-4 py-2 rounded-lg inline-block mx-2">
                  1968
                </span>
                {' '}the radio stayed warm all night
              </p>

              <p className="text-4xl md:text-5xl font-black text-gray-200 leading-tight">
                {/* genre with highlight - using neon blue for accent */}
                <span className="bg-gradient-to-r from-blue-500 to-cyan-400 text-white px-4 py-2 rounded-lg inline-block mx-2 mb-4">
                  Soul classics
                </span>
        ...
        <div className="max-w-6xl mx-auto px-6 py-6">
          ...
          <div className="flex items-center justify-center gap-6">
            ...
            <div className="text-gray-300 font-medium">
              ...
              <p className="text-lg">{progress}% complete</p>
            </div>
          </div>
